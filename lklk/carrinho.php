	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a href="paginainicial.php">Lista de Produtos</a>
	    	</div>
		</div>
		...
		<?php if($resultsCarts) : ?>
			...
			<a class="btn btn-warning"  href="compra.php?acao=add&nome=<?php echo  $nome?>&preco=<?php echo $preco?>&foto=<?php echo $foto?>&categoria=<?php echo $categoria?>" type="submit">Comprar</a>
